...
module.exports = {
    async run(database) {
        ...
        if (urlColumn) {
            ...
            await database.run(
                "CREATE TABLE IF NOT EXISTS plugins (id INTEGER NOT NULL UNIQUE PRIMARY KEY AUTOINCREMENT, name TEXT UNIQUE NOT NULL, authors TEXT UNIQUE NOT NULL, description TEXT, version TEXT)",
                []
            );
        } else {
