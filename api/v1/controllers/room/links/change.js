...
module.exports = (router) => {
     ...
     *   post:
     *     summary: Update a link in a room (DEPRECATED)
     *     deprecated: true
     *     tags:
     *       - Room - Links
     *     description: |
     *       **DEPRECATED**: Use `PUT /api/v1/room/{id}/links` instead.
     *
     *       This endpoint will be removed in a future version. Updates an existing link in a classroom (requires teacher permissions)
     *     parameters:
     *       - in: path
     *         name: id
     *         required: true
    ...
    router.post("/room/:id/links/change", hasClassPermission(TEACHER_PERMISSIONS), async (req, res) => {
        ...
        res.setHeader("Warning", '299 - "Deprecated API: Use PUT /api/v1/room/:id/links instead. This endpoint will be removed in a future version."');
