...
describe("Download Database Route", () => {
    ...
    describe("GET /downloadDatabase", () => {
        it("should set the correct headers for file download", async () => {
            const response = await request(app).get("/downloadDatabase").expect(200);
        ...
        it("should handle errors gracefully", async () => {
            ...
            const response = await request(errorApp).get("/downloadDatabase").expect(200); // Error handler returns 200
