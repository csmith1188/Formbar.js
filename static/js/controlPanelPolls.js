...
function startPoll(customPollId) {
    ...
    //console.log(rooms.students, "room");
    var userTags = []
    ...
    if (lastResponses.checked) {
        for (let [key, value] of Object.entries(rooms.students)) {
            ...
            console.log(value.pollRes);
            //lastResponseToUse.push()
            console.log(value.pollRes.buttonRes, "answer submitted");
        }
        console.log(lastResponseToUse.sort());
    }
    else {
        ...
        console.log(userBoxesChecked, "userBoxesChecked");
        console.log(userIndeterminate, "userIndeterminate");
